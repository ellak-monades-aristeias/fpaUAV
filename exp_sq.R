...
#' Ορισμός περιοχής μελέτης μέσα από τη δημιουργία bounding box. Το bounding box σε αυτή την περίπτωση 
#' είναι σε μορφή KML και γίνεται αποθήκευση αυτού στο directory που ορίσθηκε αρχικά. Έπειτα εισάγεται στο Rstudio.
...
#' Ορισμός των συντεταγμένων του κεντροειδούς ώστε να γνωρίζει ο χρήστης το σημείο από όπου θα απογειωθεί
#' η μη επανδρωμένη πλατφόρμα.
...
#' 0.03 μοίρες (η μονάδα διαφέρει ανάλογα με το προβολικό σσύστημα στο οποίο βρίσκεται το κάθε αρχείο).
...
#' σε προηγούμενο στάδιο. Με τη δημιουργία των legs, γίνεται unlist της λίστας που αποθηκεύθηκαν οι 
#' συντεταγμένες και βάση του εύρους γίνεται η απεικόνιση του μοτίβου. Ορίζονται τα στοιχεία των αξόνων 
#' καθώς και των legs(μέγεθος,χρώματα).>>>>>>> .r13
